...
const PortfolioDetail = () => {
  ...
  return <div className="min-h-screen text-white" style={{
    backgroundColor: colorSettings.backgroundColor
      ...
      <Navbar />
      <div className="container mx-auto md:py-16 px-[37px] py-[86px]">
        {/* Page Header Section */}
        <motion.div initial={{
        opacity: 0,
        y: 20
        ...
        delay: 0.1
          ...
          {project.video_url ? <div className="relative pt-[56.25%] rounded-lg overflow-hidden bg-black">
              <iframe src={getEmbedUrl(project.video_url)} title={project.title} frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="absolute inset-0 w-full h-full" loading="lazy"></iframe>
      ...
      {showVideo && project.video_url && <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90">
          <div className="relative w-full max-w-4xl mx-auto">
            ...
            <div className="aspect-video">
              <iframe src={getEmbedUrl(project.video_url)} title="Project Video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="w-full h-full"></iframe>
            </div>
          </div>
        </div>}
    </div>;
