...
export const Navbar = () => {
  ...
  useEffect(() => {
    // Load site name and logo from the database
...
const NavLink = ({
  ...
  return <Link to={to} className="group flex items-center space-x-1.5 text-white/80 hover:text-white transition-colors text-sm py-1.5"
  >
      {icon}
      <span>{label}</span>
