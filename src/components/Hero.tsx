...
export const Hero = () => {
  ...
  return (
    <section ref={heroRef} className="relative h-screen flex flex-col items-center justify-center overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-4 z-10 flex flex-col items-center text-center max-w-4xl">
        ...
        <motion.div
          ...
          className="w-full max-w-[70px] h-[2px] bg-gradient-to-r from-[#4a6cf7] to-[#9b87f5] mx-auto mb-6"
        />
        ...
        >
          <Button 
            className={`${animations3DEnabled ? 'hover:shadow-[0_0_15px_rgba(74,108,247,0.5)] transition-shadow duration-300' : ''} bg-gradient-to-r from-[#4a6cf7] to-[#9b87f5] hover:opacity-90 text-white px-6 py-2 h-auto text-base w-full sm:w-auto rounded-full shadow-lg shadow-[#4a6cf7]/20`}
            asChild
          >
          ...
          <Button 
            ...
            className={`${animations3DEnabled ? 'hover:shadow-[0_0_15px_rgba(155,135,245,0.3)] transition-shadow duration-300' : ''} border-[#9b87f5] text-white hover:bg-[#9b87f5]/10 px-6 py-2 h-auto text-base w-full sm:w-auto rounded-full`}
          >
      ...
      {animations3DEnabled && (
        <>
          ...
          >
            <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#4a6cf7] to-[#9b87f5] opacity-30 backdrop-blur-sm shadow-lg" />
          </motion.div>
          ...
          >
            <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-[#9b87f5] to-[#4a6cf7] opacity-20 backdrop-blur-sm shadow-lg" />
          </motion.div>
          ...
          >
            <div className="w-10 h-10 rounded-lg rotate-45 bg-gradient-to-r from-[#4a6cf7] to-transparent opacity-25 backdrop-blur-sm shadow-lg" />
          </motion.div>
        </>
      )}
